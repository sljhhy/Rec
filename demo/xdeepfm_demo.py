...
from rec.models.ranking import xDeepFM
...
if __name__ == '__main__':
    file = '/Users/lijunhe/Documents/projects/RecLearn/RecLearn-reclearn/data/criteo/train.txt'
    learning_rate = 0.001
    batch_size = 4096
    embed_dim = 8
    model_params = {
    ...
    with mirrored_strategy.scope():
        model = xDeepFM(feature_columns=feature_columns, **model_params)
        model.summary()
